...
class Ply:
    def __init__(self, mesh_fi=None, img=None, imgIdx=None, v_npy=None, c_npy=None):
        if mesh_fi:
            ...
            self.PlyFromNpy(npy=[v_npy, c_npy])

        else:
            print("Ply init  error")

    def PlyFromNpy(self, npy):
        self.verts_np = npy[0]
        self.colors_np = npy[1]
        self.setPara()
        self.np2infos()
    ...
    def setPara(self):
        ...
        self.num_face = 0
        self.f_infos = []
        self.num_vertex = self.verts_np.shape[0]
    ...
    def changeColor(self, r=255, g=255, b=255, sigma=255):
